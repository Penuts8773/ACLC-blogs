...
function showLatestArticle($article, $pdo, $isMain = false)
{
    ...
    echo "<div onclick='window.location.href=\"article/" . urlencode($article['title']) . "\"' class='$class' style='background-image: url(\"$thumb\")'>";
...
function showDetailedArticle($article, $pdo)
{
    ...
    echo "    <small>" . date("F d, Y", strtotime($article['created_at'])) . "</small>";
    echo "    <p class='latest-preview'>$preview</p>";
    echo "    <button onclick='window.location.href=\"article/" . urlencode($article['title']) . "\"' class='latest-read-more'>Read More</button>";
    echo "  </div>";
    echo "</div>";
}
...
function showPopularArticle($article, $pdo)
{
    ...
    echo "<div onclick='window.location.href=\"article/" . urlencode($article['title']) . "\"' class='popular-article' style='background-image: url(\"$thumb\")'>";
